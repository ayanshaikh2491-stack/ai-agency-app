...
if(manager==="website") return await websiteManager(message)

if(manager==="seo") return await seoManager(message)

if(manager==="marketing") return await marketingManager(message)

if(manager==="social") return await socialMediaManager(message)

if(manager==="automation") return await automationManager(message)

return "AI manager could not decide."
